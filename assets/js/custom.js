(function($){
	...
	$(document).ready(function() {
		...
		var moduleHero = $('.module-hero'),
			...
			worksgrid  = $('#works-grid-1'),
			worksgrid2 = $('#works-grid-2'),
			worksgrid3 = $('#works-grid-3'),
		...
		if (worksgrid2.hasClass('works-grid-masonry')) {
			worksgrid2_mode = 'masonry';
		} else {
			worksgrid2_mode = 'fitRows';
		}

		worksgrid2.imagesLoaded(function() {
			worksgrid2.isotope({
				layoutMode: worksgrid2_mode,
				itemSelector: '.work-item',
			});
		});
		...
		if (worksgrid3.hasClass('works-grid-masonry')) {
			worksgrid3_mode = 'masonry';
		} else {
			worksgrid3_mode = 'fitRows';
		}

		worksgrid3.imagesLoaded(function() {
			worksgrid3.isotope({
				layoutMode: worksgrid3_mode,
				itemSelector: '.work-item',
			});
		});
